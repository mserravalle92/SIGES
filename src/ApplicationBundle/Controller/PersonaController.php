...
use ApplicationBundle\Entity\Persona;
...
class PersonaController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $personas = $em->getRepository('ApplicationBundle:Persona')->findAll();
    ...
    {
        $persona = new Persona();
        $form = $this->createForm('ApplicationBundle\Form\PersonaType', $persona);
    ...
    public function editAction(Request $request, Persona $persona)
    {
        ...
        $deleteForm = $this->createDeleteForm($persona);
        $editForm = $this->createForm('ApplicationBundle\Form\PersonaType', $persona);
        $editForm->handleRequest($request);

        if ($persona instanceof Alumno){
            $editForm->add('dni');
            $editForm->add('fechaNacimiento',DateType::class, array(
                'input'  => 'datetime',
                'widget' => 'single_text',
                'format' => 'dd/MM/yyyy'));
            $editForm->add('mail');
            $editForm->add('telefono');
            $editForm->add('direccion');
            $editForm->add('localidad');
        }elseif($persona instanceof PersonalDocente){
            echo "sasa";
        }
